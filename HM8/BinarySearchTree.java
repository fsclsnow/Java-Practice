...
public class BinarySearchTree<E extends Comparable<E>>
    ...
    public String toStringAcs(){
        StringBuilder IOsb = new StringBuilder();
        InorderToString(IOsb, root);
        return IOsb.toString();
    }

    private void InorderToString(StringBuilder sb,Node<E> root){
        if (root.left != null) {
            InorderToString(sb, root.left);
            //sb.append(" \n");
        }
        sb.append(root);
        sb.append(" \n");
        if (root.right != null) {
            InorderToString(sb, root.right);
            //sb.append(" \n");
        }
    }
    ...
    public static void main(String[] arg) throws IOException {
            ...
            System.out.println(bst.root.data.toString());
            System.out.println(bst.toStringAcs());
            System.out.println("Inorder to String: " + bst.inorderToString());
